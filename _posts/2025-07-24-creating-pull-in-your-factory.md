...
Some of them make no sense like "How to make money without railroading" so I'll rename these later and use timestamps instead.
...
I mapped the 8 wastes as so. More details are [on the wastes are here][1]
...
# Who should be looking for unevenness and overburden
...
# How to make money without railroading
...
Let's see the tester is a little ahead, then you'd never see all the test suites pass.
